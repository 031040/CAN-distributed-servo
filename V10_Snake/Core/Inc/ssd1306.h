...
void OLED_SetPixel(uint8_t x, uint8_t y, uint8_t on);       /* pixel (0..127, 0..63)    */
void OLED_FillRect(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, uint8_t on); /* filled rect, inclusive */
